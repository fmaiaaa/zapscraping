...
Dependencias:
    pip install curl_cffi pandas numpy beautifulsoup4 openpyxl
"""
...
def _save_xlsx(data: list[dict], path: Path) -> None:
...
def scrape(
    *,
    ...
    df = _save_xlsx(all_data, OUTPUT_XLSX)
